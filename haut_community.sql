/*
 ...
 Source Host           : 172.27.101.23:3306
...
INSERT INTO `collect` VALUES (8, 1, 34, '2026-03-02 20:15:52');
...
INSERT INTO `comment` VALUES (14, '好棒', 1, 33, 0, '2026-03-02 20:08:35', '2026-03-02 20:08:35', 0);
...
) ENGINE = InnoDB AUTO_INCREMENT = 30 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_0900_ai_ci COMMENT = '点赞表' ROW_FORMAT = DYNAMIC;
...
INSERT INTO `favorite` VALUES (29, 1, 33, 2);
...
CREATE TABLE `follow`  (
  ...
  `is_deleted` tinyint NOT NULL DEFAULT 0 COMMENT '删除标记（0:可用 1:已删除）',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 21 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_0900_ai_ci COMMENT = '用户关注' ROW_FORMAT = DYNAMIC;
...
CREATE TABLE `notification`  (
  ...
  `from_user_id` bigint NULL DEFAULT NULL COMMENT 'å‘é€è€…ID',
  `to_user_id` bigint NOT NULL COMMENT 'æŽ¥æ”¶è€…ID',
  `type` tinyint NOT NULL COMMENT 'é€šçŸ¥ç±»åž‹ 1ç‚¹èµžå¸–å­ 2ç‚¹èµžè¯„è®º 3è¯„è®ºå¸–å­ 4å›žå¤è¯„è®º 5å…³æ³¨ 6ç³»ç»Ÿ',
  `target_id` bigint NULL DEFAULT NULL COMMENT 'ç›®æ ‡ID',
  `target_title` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NULL DEFAULT NULL COMMENT 'ç›®æ ‡æ ‡é¢˜æ‘˜è¦',
  `content` varchar(1000) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NULL DEFAULT NULL COMMENT 'é€šçŸ¥å†…å®¹',
  `is_read` tinyint NOT NULL DEFAULT 0 COMMENT 'æ˜¯å¦å·²è¯» 0æœªè¯» 1å·²è¯»',
  `create_time` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP COMMENT 'åˆ›å»ºæ—¶é—´',
  `update_time` datetime NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP COMMENT 'æ›´æ–°æ—¶é—´',
  `is_deleted` tinyint NOT NULL DEFAULT 0 COMMENT 'åˆ é™¤æ ‡è®° 0å¯ç”¨ 1å·²åˆ é™¤',
  PRIMARY KEY (`id`) USING BTREE,
  INDEX `idx_to_user_read`(`to_user_id` ASC, `is_read` ASC, `is_deleted` ASC) USING BTREE,
...
-- ----------------------------
INSERT INTO `notification` VALUES (1, 1, 18, 3, 33, '大家吼，我是新来的', 'admin 评论了你的帖子：好棒', 0, '2026-03-02 20:08:35', '2026-03-02 20:08:35', 0);
INSERT INTO `notification` VALUES (2, 1, 18, 1, 33, '大家吼，我是新来的', 'admin 赞了你的帖子', 0, '2026-03-02 20:17:54', '2026-03-02 20:17:54', 0);
...
CREATE TABLE `post`  (
  ...
  `status` tinyint NOT NULL DEFAULT 1 COMMENT 'çŠ¶æ€(1æ­£å¸¸ 0ä¸‹æž¶)',
...
) ENGINE = InnoDB AUTO_INCREMENT = 36 CHARACTER SET = utf8mb3 COLLATE = utf8mb3_general_ci COMMENT = '话题表' ROW_FORMAT = DYNAMIC;

-- ----------------------------
-- Records of post
-- ----------------------------
INSERT INTO `post` VALUES (1, 'hello啊大家好', ':eyes:️\n\n> 给大家看看我的新头像\n\n![53a3584b7f4460f2c6e229a2b5432a93.jpg](http://rw61twimb.hb-bkt.clouddn.com/community/fa98327347ad4012b9c2ec3e46a3a95c.jpg)\n\n\n\n', '2', 181, b'0', b'0', 1, 2, 0, '2020-12-01 00:29:01', '2023-06-24 16:28:54', 0);
INSERT INTO `post` VALUES (2, '2023 健康，快乐', '2023的`FLAG`\n\n1. 技能进步\n2. 没有烦恼\n3. 发财 :smile: \n\n', '15', 78, b'0', b'0', 1, 4, 0, '2021-01-13 22:27:21', '2023-06-22 13:45:07', 0);
INSERT INTO `post` VALUES (3, 'hello，spring-security', ':hibiscus: spring-security\n\n', '1', 56, b'0', b'0', 1, 0, 0, '2020-12-03 20:56:51', '2023-06-21 19:57:57', 0);
INSERT INTO `post` VALUES (4, '哈哈哈，helloworld', '这是第一篇哦\n\n> hi :handshake: 你好\n\n`hello world`\n\n:+1: 很好\n', '3', 30, b'0', b'0', 1, 0, 0, '2020-11-28 19:40:02', '2023-06-19 23:22:51', 0);
INSERT INTO `post` VALUES (5, '哈哈哈，换了个dark主题', '主题更换为Dark\n\n', '1', 17, b'0', b'0', 1, 0, 0, '2020-11-30 23:27:00', '2023-06-23 20:08:10', 0);
INSERT INTO `post` VALUES (6, '嘿嘿，测试一下啊', '大家好\n`Hello everyone!`\n\n\n\n', '4', 19, b'0', b'0', 1, 0, 0, '2020-12-01 15:04:26', '2023-06-20 11:25:35', 0);
INSERT INTO `post` VALUES (7, '我要发财', '2023 冲冲冲！！！\n\n', '1', 109, b'0', b'0', 1, 0, 0, '2020-11-28 21:47:16', '2023-06-23 20:10:15', 0);
INSERT INTO `post` VALUES (9, '权限部分 OK', '1. 创建 ok\n2. 修改 ok\n3. 删除 ok\n\n', '5', 28, b'0', b'0', 1, 0, 0, '2021-01-14 16:16:49', '2023-06-21 19:57:26', 0);
INSERT INTO `post` VALUES (10, '测试', '测试\n\n', '1', 39, b'0', b'0', 1, 0, 0, '2020-12-01 15:35:34', '2023-06-18 17:11:55', 1);
INSERT INTO `post` VALUES (11, '聚合查询并统计', '* [x] SQL：\n\n```sql\nSELECT s.*,\nCOUNT(t.id) AS topics\nFROM section s\nLEFT JOIN topic t\nON s.id = t.section_id\nGROUP BY s.title\n```\n\n', '1', 59, b'0', b'0', 1, 0, 0, '2020-11-28 21:42:16', '2023-06-21 19:58:03', 0);
INSERT INTO `post` VALUES (12, '视频嵌入', ':+1:\n\n[https://www.bilibili.com/video/BV1w64y1f7w3](https://www.bilibili.com/video/BV1w64y1f7w3)\n\n[1](https://www.bilibili.com/video/BV1tp4y1x72w)\n\n```\n.vditor-reset pre > code\n```\n\n```\npublic class HelloWorld {\n\npublic static void main(String[] args) {\n    System.out.println(\"Hello World!\");\n}\n}\n```\n\n', '5', 56, b'0', b'0', 1, 0, 0, '2020-12-05 17:12:16', '2023-06-21 19:57:46', 0);
INSERT INTO `post` VALUES (18, '111', '<pre><code >1111</code></pre><p><br></p>', '1', 0, b'0', b'0', 1, 0, 0, '2023-06-12 20:12:49', '2023-06-12 20:12:49', 1);
INSERT INTO `post` VALUES (21, '权限部分 OK!', '<p>1. 创建 ok</p><p>2. 修改 ok</p><p>3. 删除 ok</p><p><br></p><p><br></p>', '1', 0, b'0', b'0', 1, 0, 0, '2023-06-12 20:45:12', '2023-06-12 20:45:12', 1);
INSERT INTO `post` VALUES (22, '权限部分 OK!', '<p>1. 创建 ok</p><p>2. 修改 ok</p><p>3. 删除 ok</p><p><br></p><div data-w-e-type=\"video\" data-w-e-is-void>\n<video poster=\"\" controls=\"true\" width=\"auto\" height=\"auto\"><source src=\"https://www.bilibili.com/video/BV1Am4y1v745\" /></video>\n</div><p><br></p>', '5', 0, b'1', b'0', 1, 0, 0, '2023-06-12 20:46:42', '2023-06-18 23:58:09', 1);
INSERT INTO `post` VALUES (23, '现在是2023年6月15日20:36:37', '**课设好难啊，不知道写啥**\n\n---\n\n:confused: 哎，写的好像还行\n\n', '1', 71, b'0', b'0', 1, 0, 0, '2023-06-15 20:37:49', '2023-06-24 16:28:50', 0);
INSERT INTO `post` VALUES (25, '测试css', '##### 123\n\n---\n\n1. 首先，点个赞\n\n:+1:\n\n', '1', 28, b'0', b'0', 1, 0, 0, '2023-06-18 20:08:20', '2023-06-24 16:16:16', 0);
INSERT INTO `post` VALUES (26, '测试vditor', '你好\n:smile:\n\n### hi\n\n* [ ] 123\n  qw\n\n> qw\n> qw`d`\n\n', '15', 6, b'0', b'0', 1, 0, 0, '2023-06-18 20:50:12', '2023-06-19 00:12:11', 1);
INSERT INTO `post` VALUES (27, '测试文件上传', '![29aeb9db309305157567c237ceede3e0.jpeg](http://rw61twimb.hb-bkt.clouddn.com/community/86d7d8f536954338aff5cc3d08dbdf6b.jpeg)\n\n123\n[20230618224644812.mp4](http://rw61twimb.hb-bkt.clouddn.com/community/6744ad8ec1a74e92a6fd657d43ce58e9.mp4)\n[Java.md](http://rw61twimb.hb-bkt.clouddn.com/community/44de20ee0de644b78966d7bfa0c33663.md)\n\n', '1', 52, b'1', b'0', 1, 0, 0, '2023-06-18 22:40:59', '2026-03-02 20:14:23', 0);
INSERT INTO `post` VALUES (28, '我也来发个帖子', '* [ ] 我的新头像\n\n:tada:️\n\n![53a3584b7f4460f2c6e229a2b5432a93.jpg](http://rw61twimb.hb-bkt.clouddn.com/community/87943f7df2954c7aa0e7e799e06d625c.jpg)\n\n', '15', 32, b'0', b'0', 1, 0, 0, '2023-06-19 00:03:29', '2023-06-21 19:57:34', 0);
INSERT INTO `post` VALUES (29, '大家好，我是新来的', '冒个泡。。。\n\n![694ed4f96a14ca2299711140fdafc39b.jpg](http://rw61twimb.hb-bkt.clouddn.com/community/837e20e8ee47439792d2836104e69617.jpg)\n', '3', 72, b'0', b'0', 1, 0, 0, '2023-06-19 00:04:52', '2026-03-02 19:42:33', 0);
INSERT INTO `post` VALUES (30, '测试一下标签啊', '这里是测试数据\n\n', '1', 3, b'0', b'0', 1, 0, 0, '2023-06-19 08:39:22', '2023-06-19 08:41:34', 1);
INSERT INTO `post` VALUES (31, '测试', '测试一下删除标签\n', '1', 1, b'0', b'0', 1, 0, 0, '2023-06-19 08:47:07', '2023-06-19 08:47:21', 1);
INSERT INTO `post` VALUES (32, '测试一下匿名功能', '测试测试\n\n', '1', 81, b'0', b'1', 1, 0, 1, '2023-06-20 09:35:18', '2023-06-24 16:25:08', 0);
INSERT INTO `post` VALUES (33, '大家吼，我是新来的', ':tada:️ :tada:️ :tada:️ **热烈庆祝社区开业！！！**\n\n![6c88453c10b1d9c750033ad184e4bdb6.jpeg](http://rw61twimb.hb-bkt.clouddn.com/community/bf62a03a2d774b60ac7f95308d646e8d.jpeg)\n', '18', 47, b'1', b'1', 1, 5, 0, '2023-06-21 20:42:50', '2026-03-02 20:19:23', 0);
INSERT INTO `post` VALUES (34, '测试发帖', '测试发帖\n', '1', 3, b'0', b'0', 1, 0, 1, '2023-06-24 19:44:30', '2026-03-02 20:19:23', 0);
INSERT INTO `post` VALUES (35, '工大附近好吃的', '洛馍村，手抓饼，重庆小面\n', '1', 2, b'0', b'0', 1, 0, 0, '2026-03-02 19:56:45', '2026-03-02 20:09:23', 0);
...
) ENGINE = InnoDB AUTO_INCREMENT = 120 CHARACTER SET = utf8mb3 COLLATE = utf8mb3_general_ci COMMENT = '话题-标签 中间表' ROW_FORMAT = DYNAMIC;

-- ----------------------------
-- Records of post_tag
-- ----------------------------
INSERT INTO `post_tag` VALUES (99, 17, 27);
...
INSERT INTO `post_tag` VALUES (117, 14, 33);
...
-- Records of sys_user
-- ----------------------------
INSERT INTO `sys_user` VALUES (1, 'admin', '96e79218965eb72c92a549dd5a330112', 'admin', 'admin@qq.com', 1, 'http://rw61twimb.hb-bkt.clouddn.com/community/c2a4a3e9e1f341d486ab5d854d9d747b.jpeg', 1, '我是超级管理员', 1, '2021-05-31 18:08:43', '2023-06-24 20:29:16', 0);
INSERT INTO `sys_user` VALUES (2, '王倩倩', '96e79218965eb72c92a549dd5a330112', '王倩倩', 'wqq@qq.com', 0, 'http://rw61twimb.hb-bkt.clouddn.com/headphoto/29aeb9db309305157567c237ceede3e0.jpeg', 1, '普通管理员', 1, '2022-02-08 10:35:38', '2023-06-22 13:39:28', 0);
INSERT INTO `sys_user` VALUES (3, '王刚', '96e79218965eb72c92a549dd5a330112', '王刚', 'wanggang@qq.com', 1, 'http://rw61twimb.hb-bkt.clouddn.com/694ed4f96a14ca2299711140fdafc39b.jpg', 1, '审帖员', 1, '2022-05-24 11:05:40', '2023-06-22 13:39:49', 0);
INSERT INTO `sys_user` VALUES (4, 'auth', '96e79218965eb72c92a549dd5a330112', 'authTest', 'auth@qq.com', 1, 'http://rw61twimb.hb-bkt.clouddn.com/community/473b478ca2bf4bb49cafd1e4a13a94d5.jpeg', 1, '用户管理员', 1, '2023-05-10 23:19:32', '2023-06-22 13:40:08', 0);
INSERT INTO `sys_user` VALUES (5, 'nice', '96e79218965eb72c92a549dd5a330112', 'nice', 'nice@qq.com', 0, 'http://rw61twimb.hb-bkt.clouddn.com/community/0c1383239cbc4a6f80dde19e7d9cf2b0.jpeg', 1, '审核员', 1, '2023-06-04 16:08:58', '2023-06-22 13:40:28', 0);
INSERT INTO `sys_user` VALUES (15, '小弟弟', '96e79218965eb72c92a549dd5a330112', '小弟弟', 'liyuanhaovip@163.com', 1, 'http://rw61twimb.hb-bkt.clouddn.com/community/03fa9270e8934e579efc007e4eb9b6c7.jpg', 5, 'little小弟弟', 1, '2023-06-05 16:47:48', '2023-06-22 13:38:44', 0);
INSERT INTO `sys_user` VALUES (18, '李元昊', '96e79218965eb72c92a549dd5a330112', 'Ephemeral', 'LiYH_0703@foxmail.com', 1, 'http://rw61twimb.hb-bkt.clouddn.com/community/b4b4bb237e6f49c6ac68527099ef9b9f.jpeg', 3, '大家吼~~~', 1, '2023-06-21 20:20:54', '2023-06-22 13:38:56', 0);
...
) ENGINE = InnoDB AUTO_INCREMENT = 19 CHARACTER SET = utf8mb3 COLLATE = utf8mb3_general_ci COMMENT = '用户角色' ROW_FORMAT = DYNAMIC;
...
) ENGINE = InnoDB AUTO_INCREMENT = 22 CHARACTER SET = utf8mb3 COLLATE = utf8mb3_general_ci COMMENT = '标签表' ROW_FORMAT = DYNAMIC;
...
CREATE TABLE `tip`  (
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 24869 CHARACTER SET = utf8mb3 COLLATE = utf8mb3_general_ci COMMENT = '每日赠言' ROW_FORMAT = DYNAMIC;
